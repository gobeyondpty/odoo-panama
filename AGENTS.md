...
This repository is the long-term home for Panama Odoo localization modules. It owns `l10n_pa`, `l10n_pa_edi`, `l10n_pa_edi_factura_facil`, `l10n_pa_account_withholding`, `l10n_pa_reports`, `l10n_pa_hr_payroll`, and `l10n_pa_hr_payroll_account`. The planned `l10n_pa_hr_payroll_sipe` will land here as well.
...
`l10n_pa_account_withholding` and `l10n_pa_reports` depend on `l10n_pa` (now in-repo, no longer cross-repo). `l10n_pa_hr_payroll_account` depends on `l10n_pa_hr_payroll`.
